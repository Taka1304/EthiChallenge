...
import { Box, Link, VStack, Button, Heading } from "@yamada-ui/react";
  ...
  return (
    ...
    >
      ...
      <Box marginBottom={"5vh"}>
        {/* 終了ボタン */}
        <Button bg={"#ffaa8c"} boxShadow="0px 3px 10px rgba(0, 0, 0, 0.25)">
          終了する
        </Button>
      </Box>
      {/* END */}
      ...
      >
        ...
        <Box
          ...
          alignItems={"center"}
        >
          <Heading fontSize={"10vh"}>RESULT</Heading>
        </Box>
        {/* END */}
